...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="https://preview.webpixels.io/boomerang-v3.6/assets/vendor/bootstrap/css/bootstrap.min.css" type="text/css">
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="https://preview.webpixels.io/boomerang-v3.6/assets/fonts/font-awesome/css/font-awesome.min.css" type="text/css">
    ...
    <!-- Global style (main) -->
    <link id="stylesheet" type="text/css" href="https://preview.webpixels.io/boomerang-v3.6/assets/css/boomerang.min.css" rel="stylesheet" media="screen">
                                                            ...
                                                            <div class="dropdown-cart px-0">
                                                                ...
                                                                <div class="dc-item">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="dc-image">
                                                                            <a href="#">
                                                                                <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/prv/shop/accessories/img-1a.png" class="img-fluid" alt="">
                                                                            </a>
                                                                        </div>
                        ...
                        Wood phone case
                                                                ...
                                                                <div class="dc-item">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="dc-image">
                                                                            <a href="#">
                                                                                <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/prv/shop/accessories/img-2a.png" class="img-fluid" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="dc-content">
                <span class="d-block dc-product-name text-capitalize strong-600 mb-1">
                        ...
                        Leather bag
                                                                ...
                                                                <div class="dc-item">
                                                                    <div class="d-flex align-items-center">
                                                                        <div class="dc-image">
                                                                            <a href="#">
                                                                                <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/prv/shop/accessories/img-3a.png" class="img-fluid" alt="">
                                                                            </a>
                                                                        </div>
                                                                        <div class="dc-content">
                <span class="d-block dc-product-name text-capitalize strong-600 mb-1">
                        ...
                        <nav class="navbar navbar-expand-lg navbar--bold navbar-light bg-default  navbar--bb-1px">
                            <div class="container navbar-container">
                                ...
                                <a class="navbar-brand" href="../../index.html">
                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/logo/logo-1-b.png" class="" alt="Boomerang">
                                </a>
                                        ...
                                        <li class="nav-item dropdown megamenu">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="mega-dropdown-menu row row-no-padding">
                                                    <div class="mega-dropdown-col mega-dropdown-col-cover mega-dropdown-col-cover--left col-lg-5 d-none d-lg-block d-xl-block" style="background-image: url(https://preview.webpixels.io/boomerang-v3.6/assets/images/prv/other/img-14-1000x900.jpg); background-position: center center;">
                                        ...
                                        <div class="sidebar sidebar--style-2 no-border stickyfill">
                                            <div class="widget">
                                                ...
                                                <div class="profile-picture profile-picture--style-2">
                                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/prv/people/person-7.jpg" class="img-center">
                                    ...
                                    <div class="col-lg-8">
                                        <div class="main-content">
                                            ...
                                            <div class="link-menu link-menu--style-3 py-4 border-bottom">
                                                ...
                                                <a href="../../pages/profile/account-cards.html" class="active">Cards</a>
                                                    ...
                                                    <ul class="list-group">
                                                        <li class="list-group-item bg-transparent">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <div class="col-8">
                                                                            <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/visa.png" width="30" class="mr-1">
                                                                            x-1023 (Expires on 11/2018)
                                                                        </div>
                                                                        <div class="col-4 text-right">
                                                                            <a href="#" class="link link--style-3" data-toggle="tooltip" data-original-title="Remove card">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-8">
                                                                            <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/skrill.png" width="30" class="mr-1">
                                                        ...
                                                        <li class="list-group-item bg-transparent">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-8">
                                                                    <strong>$28.00 <small>U.S Dollar</small></strong>
                                                                </div>
                                                            </div>
                                                        </li>
                                                        <li class="list-group-item bg-transparent">
                                                ...
                                                <form class="form-default mt-4" data-toggle="validator" role="form">
                                                    <div class="card ">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-lg-8">
                                                                    <h3 class="heading heading-6 strong-600">Credit Card</h3>
                                                                ...
                                                                <div class="col-lg-4 text-lg-right">
                                                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/mastercard.png" width="40" class="mr-2">
                                                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/visa.png" width="40" class="mr-2">
                                                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/skrill.png" width="40">
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="card mt-4">
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col-8">
                                                                    <h3 class="heading heading-6 strong-600" for="radioPayment_2">PayPal</h3>

                                                                    <p class="c-gray-light mt-2">
                                                                        Pay your order using the most known and secure platform for online money transfers. You will be redirected to
                                                                        PayPal to finish complete your purchase.
                                                                    </p>
                                                                </div>

                                                                <div class="col-4 text-right">
                                                                    <img src="https://preview.webpixels.io/boomerang-v3.6/assets/images/icons/cards/paypal-256x160.png" width="100">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="text-right mt-3">
                                                                <a href="#" class="btn btn-styled btn-block btn-lg btn-base-1">Pay with PayPal</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
